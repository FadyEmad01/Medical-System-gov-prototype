...
| UI Kit | shadcn/ui | `radix-ui` ^1.6.7 primitives, vendored in `src/components/ui` |
...
| Tests | Vitest ^4.1.10 | happy-dom default, `node` env for server-only tests, Testing Library |
